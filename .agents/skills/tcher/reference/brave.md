...
**WARNING - AI SLOP TRAP**: Review ALL the DON'T guidelines from the parent tcher skill (already loaded in this context) before proceeding. Bold means distinctive, not "more effects."
...
- **Replace generic fonts**: Swap system fonts for distinctive choices (see the parent skill's typography guidelines and the [Reference Material section of typo.md](typo.md#reference-material) for inspiration)
...
When the result feels right, hand off to `/tcher refine` for the final pass.
